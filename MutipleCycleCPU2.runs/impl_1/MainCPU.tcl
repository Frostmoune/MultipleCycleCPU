...
set rc [catch {
  ...
  add_files -quiet E:/CPU/MutipleCycleCPU2/MutipleCycleCPU2.runs/synth_1/MainCPU.dcp
...
set rc [catch {
  ...
  create_report "impl_1_opt_report_drc_0" "report_drc -file MainCPU_drc_opted.rpt -pb MultipleCycleCPU_drc_opted.pb -rpx MultipleCycleCPU_drc_opted.rpx"
...
set rc [catch {
  ...
  write_bitstream -force MainCPU.bit 
